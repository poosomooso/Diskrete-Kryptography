...
from elliptic_curve import inverse_mod, e_curve as curve
...
class PollardRhoSequence:
    ...
    def __init__(self, point1, point2):
        ...
        self.add_x1 = curve.add_points(
            curve.mult_point(point1, self.add_a1),
            curve.mult_point(point2, self.add_b1),
        )

        self.add_a2 = random.randrange(1, curve.n)
        self.add_b2 = random.randrange(1, curve.n)
        self.add_x2 = curve.add_points(
            curve.mult_point(point1, self.add_a2),
            curve.mult_point(point2, self.add_b2),
        )

    def __iter__(self):
        partition_size = curve.field // 3 + 1
